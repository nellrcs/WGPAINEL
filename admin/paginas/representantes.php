<?php
	class representantes
	{
		...
		*/
		...
		public static $tabela = "representantes"; 	
		public static $menu_nome = array('Representantes'=>'pagina=representantes');
		...
		public static function novo()
		{
			...
			$form::$method = "POST";
			$form::$html_botao = "<br>".html_upload_foto(self::$largura,self::$altura,self::$tamnaho_k_bytes)."<br><button type='submit' class='btn btn-primary'> SALVAR </button>";
			...
			$paramtros_obj['nome'] = $form::index(array('tipo'=>0,'campo'=>'nome','label'=>true,'html_depois'=>'<br>','titulo'=>'Nome'));
			
			$paramtros_obj['cidade'] = $form::index(array('tipo'=>0,'campo'=>'cidade','label'=>true,'html_depois'=>'<br>','titulo'=>'Cidade'));

			$paramtros_obj['telefone'] = $form::index(array('tipo'=>0,'campo'=>'telefone','label'=>true,'html_depois'=>'<br>','titulo'=>'Telefone','mascara'=>'(00) 0000-0000'));

			$paramtros_obj['email'] = $form::index(array('tipo'=>0,'campo'=>'email','label'=>true,'html_depois'=>'<br>','titulo'=>'Email'));
		...
		public static function editar($base)
		{
			...
			/* capos relativos ao metodo cria_tebelas */
			$paramtros_obj['nome'] = $form::index(array('tipo'=>0,'campo'=>'nome','label'=>true,'titulo'=>'Nome','html_depois'=>'<br>','valor'=>$ln->nome));
			$paramtros_obj['cidade'] = $form::index(array('tipo'=>0,'campo'=>'cidade','label'=>true,'titulo'=>'Cidade','html_depois'=>'<br>','valor'=>$ln->cidade));
			$paramtros_obj['telefone'] = $form::index(array('tipo'=>0,'campo'=>'telefone','label'=>true,'titulo'=>'Telefone','html_depois'=>'<br>','valor'=>$ln->telefone));
			$paramtros_obj['email'] = $form::index(array('tipo'=>0,'campo'=>'email','label'=>true,'titulo'=>'Email','html_depois'=>'<br>','valor'=>$ln->email));
